(async function () {
  ...
  if (section !== "CEPZ-Export") {
    console.log("⛔ Not CEPZ-Export page");
    return;
  }
  ...
  const API_URL = "https://script.google.com/macros/s/AKfycbwlfKoLcWyxIgbB8qbUc4TMfQPBx2as-47e3glHLsiHgXccRbEDtbghr8nAxj-1z_Fs/exec";

  const CACHE_KEY = 'receipt_cepz_export_cache_v2';

  // 🔹 GM_xmlhttpRequest কে Promise এ রূপান্তরকারী হেলপার ফাংশন
  ...
  function renderTableData(dataArray, startDate, endDate) {
    ...
    console.log(`📊 Rendered. Site MR preserved & Script MR auto-incremented.`);
  }
})();
